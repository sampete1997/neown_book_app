...
const BookRow = ({ book }) => {
  return (
    <div className='hover:scale-105 transform transition-transform duration-300 m-2 py-2 border border-1 border-gray-300 rounded-lg w-[22%] flex flex-col items-center justify-center bg-gray-300 hover:bg-gray-200'>
      <div className='flex flex-col items-center justify-center'>
        <img src={book.url} alt={book.title} style={{ width: "80%" }} />
      </div>
